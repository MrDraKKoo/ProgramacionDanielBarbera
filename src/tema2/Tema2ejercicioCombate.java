...
public class Tema2ejercicioCombate {
    public static void main(String[] args) {
        ...
        System.out.println("Quieres un personaje 1.predeterminado o 2.personalizarlo?");
        predeterminado1 = in.nextInt();
        switch (predeterminado1) {
            case 1: {
                //personaje predeterminado
                vida_personaje = 100;
                defensa_personaje = 100;
                ataque_personaje = 100;
                velocidad_personaje = 100;
                break;
            }
            case 2: {
                //presonaje personalizado
        ...
        switch (predeterminado2) {
            case 1: {
                //personaje predeterminado
                vida_personaje2 = 100;
                defensa_personaje2 = 100;
                ataque_personaje2 = 100;
                velocidad_personaje2 = 100;
                break;
            }
            case 2: {
                //presonaje personalizado
        ...
        while (vida_personaje > 0 && vida_personaje2 > 0) {
            ...
            if (cooldownDefensa1 == 1) {
                System.out.println("No puedes defender este turno, debes atacar! ⚔️");
                opcion1 = 1;
            } else {
            ...
            // Mostrar barra de vida de jugador 1
            System.out.print("Jugador 1 [");
            for (int i = 0; i < vida_personaje / 10; i++) System.out.print("❤️");
            if (vida_personaje % 10 > 0) System.out.print("💔");
            System.out.println("] " + vida_personaje);
            ...
            // Mostrar barra de vida de jugador 2
            System.out.print("Jugador 2 [");
            for (int i = 0; i < vida_personaje2 / 10; i++) System.out.print("❤️");
            if (vida_personaje2 % 10 > 0) System.out.print("💔");
            System.out.println("] " + vida_personaje2);
            ...
            if (opcion1 == 3) {
                if (vida_personaje == vida_personaje_inicial) {
                    ...
                    System.out.println("Jugador 1 se ha curado 🩹 ahora tiene " + vida_personaje);
                }
            }
            ...
            // Si el jugador elige la opción 2 se defiende
            if (opcion1 == 2 || opcion2 == 2) {
                if (opcion1 == 2) {
                    System.out.println("Jugador 1 se ha defendido y bloquea el ataque! 🛡️🛑");
                    cooldownDefensa1 = 1; // Ahora no podrá defender el siguiente turno
                } else {
                    cooldownDefensa1 = 0; // Resetea el cooldown si no se defendió
                }

                if (opcion2 == 2) {
                    System.out.println("Jugador 2 se ha defendido y bloquea el ataque! 🛡️🛑");
                    cooldownDefensa2 = 1; // Ahora no podrá defender el siguiente turno
                } else {
                    cooldownDefensa2 = 0; // Resetea el cooldown si no se defendió
                }
