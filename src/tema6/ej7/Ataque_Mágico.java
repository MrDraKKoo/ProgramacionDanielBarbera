...
public class Ataque_Mágico implements IAtaque{
    ...
    public Ataque_Mágico (double coste, double danyoInflingido){
        this.coste = coste;
        this.danyoInflingido = danyoInflingido;
    }

    public Ataque_Mágico (){
    ...
    @Override
    public void lanzar(){
        System.out.println("Lanzando un atque magico");
    }
}
